...
4. [Tasks]({{ site.baseurl }}/docs/Manual/Tasks)
  a. [Identify]({{ site.baseurl }}/docs/Manual/Identify)
  b. [Auto Tagging]({{ site.baseurl }}/docs/Manual/AutoTagging)
  c. [Scene Filename Parser]({{ site.baseurl }}/docs/Manual/SceneFilenameParser)
  d. [JSON Specification]({{ site.baseurl }}/docs/Manual/JSONSpec)
...
7. [Metadata Scraping]({{ site.baseurl }}/docs/Manual/Scraping)
  a. [Scraper Development]({{ site.baseurl }}/docs/Manual/ScraperDevelopment)
8. [Plugins]({{ site.baseurl }}/docs/Manual/Plugins)
  a. [External]({{ site.baseurl }}/docs/Manual/ExternalPlugins)
  b. [Embedded]({{ site.baseurl }}/docs/Manual/EmbeddedPlugins)
